...
public class FetchingEMail {
    ...
    public static void writePart(Part p,PrintWriter writer) throws Exception {
         ...
         * System.out.println("--------> image/jpeg"); Object o =
         * p.getContent();
         * 
         * InputStream x = (InputStream) o; // Construct the required byte array
         * System.out.println("x.length = " + x.available()); while ((i =
         * x.available()) > 0) { int result = (int) (x.read(bArray)); if (result
         * == -1) int i = 0; byte[] bArray = new byte[x.available()];
         * 
         * break; } FileOutputStream f2 = new
         * FileOutputStream("/tmp/image.jpg"); f2.write(bArray); }
         */
